 ...
 * @author Ryzen 5
 */
public class ConsultarEstudiante extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        cu.setConsultarEstudiante(this);
        bandera = cu.consultarEstudiante();
        if (bandera == true) {
            MostrarConsulta mostrar = new MostrarConsulta();
            cu.setMostrar(mostrar);
            cu.mostrarCamposConsultarEstudiante();
